...
class _AddAdPageState extends State<AddAdPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _selectedCategory =
          Provider.of<CategoryProvider>(context, listen: false).categories[0];
      Client client =
          Provider.of<ClientProvider>(context, listen: false).client;
      _phoneController.text = client.phone;
      _sellerController.text = client.fullname;
    });
  }

  List<String> type_fr = ["À vendre", "À louer"];
  List<String> type_ar = ["بيع", "إيجار"];
  ...
  _submit() async {
    ...
    Ad ad = Ad(
        ...
        machineCategory: _selectedMachineCategory,
        type: _type);
    bool res = await Provider.of<AdProvider>(context, listen: false).addAd(ad);
    Navigator.of(context).pop();
    if (res) {
      Config.showAler(context,
          title: context.locale.success,
          message: context.locale.add_success,
      ...
      Config.showAler(context,
          ...
          message: context.locale.add_error,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          context.locale.ajouter_annonce,
